...
export default function TechniqueAccordion({ techniques, label = 'Supporting Analysis Techniques' }: TechniqueAccordionProps) {
  ...
  return (
    <div className="cyber-card overflow-hidden card-hover">
        ...
        {techniques.map((technique, i) => {
          ...
          return (
            <div key={i}>
              <button
                onClick={() => toggle(i)}
                className="w-full flex items-center gap-2.5 px-4 py-2.5 text-left tech-item-hover border-l-3 border-l-transparent"
              >
                <div
                ...
                <span
                  className="text-[9px] font-bold font-mono px-1.5 py-0.5 rounded uppercase shrink-0 transition-colors"
              ...
              {isExpanded && (
                <div className="px-4 pb-3 accordion-expanding">
