...
export default function AnalysisResult({ report }: AnalysisResultProps) {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      {/* ── Case Header ── */}
      <div className="cyber-card p-4 card-hover">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 text-xs font-mono">
          <div className="bg-surface rounded-lg p-2.5 border border-border/50">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={() => copyToClipboard(report.id, setCopiedId)} className="copy-btn text-text-muted">
        ...
        <div className="mt-2 bg-surface rounded-lg p-2.5 border border-border/50 flex items-center gap-2">
          ...
          <button onClick={() => copyToClipboard(hashValue, setCopiedHash)} className="copy-btn text-text-muted shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="cyber-card p-5 flex flex-col items-center justify-center hover-lift">
        ...
        <div className="cyber-card p-5 hover-lift">
      ...
      <div className="flex items-center justify-center gap-4 pt-1 pb-4">
        <a
          ...
          download
          className="flex items-center gap-2 px-6 py-3 rounded-xl bg-primary/20 border border-primary/30 text-primary font-mono font-medium text-sm button-hover no-underline hover:bg-primary/30 hover:shadow-[0_6px_16px_rgba(0,255,136,0.15)] hover:border-primary/50"
        >
